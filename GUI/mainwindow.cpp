...
MainWindow::MainWindow(QWidget *parent)
    ...
    QLabel *title = new QLabel("Seleziona tipo di prodotto da aggiungere:", this);
...
void MainWindow::onViewClicked() {
    if (typeComboBox->currentText() == "Book") {
        ...
        for (int i = 0; i < books.size(); ++i) {
            ...
            tableWidget->setItem(i, 0, new QTableWidgetItem(QString::fromStdString(b.getName())));
            tableWidget->setItem(i, 1, new QTableWidgetItem(QString::fromStdString(b.getAuthor())));
            tableWidget->setItem(i, 2, new QTableWidgetItem(QString::number(b.getPrice())));
            tableWidget->setItem(i, 3, new QTableWidgetItem(QString::number(b.getTotalCopies())));
            tableWidget->setItem(i, 4, new QTableWidgetItem(QString::fromStdString(b.getLanguage())));
        }
