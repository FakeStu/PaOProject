...
public:
    Movie(string name, double price, QDateTime date, int totalCopies, string image, string director, string photo_director, string protagonist, int duration, string genre);
