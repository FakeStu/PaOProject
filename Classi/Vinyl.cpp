...
Vinyl::Vinyl(string name, double price, QDateTime date, int totalCopies, string image, string artist, string publisher, int duration, string color, FormatType format, SpeedType speed)
    : Disk(name, price, date, totalCopies, image, artist, publisher, duration), color(color), format(format), speed(speed) {}
