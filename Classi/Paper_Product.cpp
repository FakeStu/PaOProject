...
Paper_Product::Paper_Product(string name, double price, QDateTime date, int totalCopies, string image, string author, string editor, string genre, int pages)
    : Product(name, price, date, totalCopies, image), author(author), editor(editor), genre(genre), pages(pages) {}
