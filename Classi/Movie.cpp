...
Movie::Movie(string name, double price, QDateTime date, int totalCopies, string image, string director, string photo_director, string protagonist, int duration, string genre)
    : Product(name, price, date, totalCopies, image), director(director), photo_director(photo_director), protagonist(protagonist), duration(duration), genre(genre) {}
